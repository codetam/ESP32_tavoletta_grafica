        ...
        if(uid != "" && pwd != "" && action != ""){
          ...
          if(action == "login"){
            if(status == 200){
              ...
              Serial.println("New user: " + uid + " " + pwd);
              strcpy(topic, "gtab/");
              strcat(topic, uid.c_str());
              Serial.print("Subscribing at topic: ");
